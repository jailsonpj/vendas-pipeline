...
type XlsxData struct {
	Data    string `xlsx:"column(data)"`
	Escrv      string `xlsx:"escrv"`
	Material string `xlsx:"material"`
	GrpMerc string  `xlsx:"grp.merc."`
	QtdFaturd string `xlsx:"qtd.faturd"`
...
//InsertionCSV - insere dados no elastic
func InsertionCSV(data *Vendas) error {
...
//InsertionXLSX - insere dados no elastic
func InsertionXLSX(data Data) error {
...
//InsertionTXT - insere dados no elastic
func InsertionTXT(data Data) error {
